...
int main(int argc, char **argv)
{
  ...
  unsigned int seed = 1238785342;
  // unsigned int seed = 1167210709;    // 919 for benchmark vedio
  // unsigned int seed = 366209647;   // heart for girl
  
  // unsigned int seed = 4077322801; // 911:ql

  // unsigned int seed = 105493340;

  // unsigned int seed = 1202374380; //VRB tuning
  // unsigned int seed = 924743480;     // benchmark_1
  // unsigned int seed = 2412524711;
  // unsigned int seed = 3681354496;    // Z
  // unsigned int seed = 3824528994;    // J
  // unsigned int seed = 2291297351;    // U
  // unsigned int seed = 2681141334;    // normal hexagon
  // unsigned int seed = 2087670834;    // regular tetrahedron

  //Seed selection Boys: 
  //1743652202  seed-1 (hexagon 150-25-obs)

  //624131144   seed-2 (hex 125-obs) (rotation)
  //4180232711 (hex-150-0.4rad)

  // --- 30-x-width----------------

  //570356583 (hex-140-25-0.4*0.4) (so-so) (benched-graph/relative)

  //105493340 (hex-60-0-0.5*0.5) (benched- vrb/relative/graph)
  //          (hex-100-10-0.5*0.5) (benched- vrb/relative/graph)
